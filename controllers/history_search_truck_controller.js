...
router.get("/history_search_truck", authAdmin, function (req, res) {
    connection.query("SELECT * FROM input_truck_payment_db;", function (err, data) {
        if (err) {
            ...
            res.render("history_search_truck", { b_division: data });
        }
        else {
            res.send('Please login to view this page!');
        }
...
router.get("/history_pages/list_truck_payment_history/:input_truck_payment_truck_no", function (req, res) {
            ...
            connection.query("SELECT * FROM information_driver_db;", function (err, driverData) {
                connection.query("SELECT * FROM information_truck_db;", function (err, truckData) {
                    if (err) {
                        ...
                        res.render("history_pages/list_truck_payment_history", {truckPaymentData, ownerData, driverData, truckData });
                    };
                });
            });
        });
